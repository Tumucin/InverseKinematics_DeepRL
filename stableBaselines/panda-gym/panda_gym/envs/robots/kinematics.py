import sys
sys.path.append('/home/tumu/anaconda3/envs/stableBaselines/panda-gym/panda_gym/envs/robots/kdl_parser/kdl_parser_py/kdl_parser_py/')
import PyKDL
...
if __name__ == '__main__':
    ...
    printKDLChain(kinematics.armChain)
